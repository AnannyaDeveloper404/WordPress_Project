...
class MyNotes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".create-note").on("click", this.createNote);
  }
  deleteNote(e) {
...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keyup", e => this.keyPressDispatcher(e));
